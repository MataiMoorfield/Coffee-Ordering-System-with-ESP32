...
A simple web based coffee (menu can be
modified for any beverage) ordering system with the ESP32 for cafés. Full video [here](https://www.youtube.com/watch?v=jhMNulLlHCo). 
